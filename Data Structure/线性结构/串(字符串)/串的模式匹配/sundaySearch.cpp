...
std::vector<int> sundaySearch(const std::string& text, const std::string& pattern) {
...
int main() {
    std::string text = "ABAAABCDABABCABAB";
    std::string pattern = "ABABCABAB";
    std::vector<int> matchIndexes = sundaySearch(text, pattern);
